...
rep_mpi_2 = repetitions(df,"mpi_Other", corte=0.2,link_phi = "log", link_mu = "logit",distancia = "hellinger",nreps=10)
...
saveRDS(rep_mpi_2,"rep_mpi_2.Rdata")
...
mapply(c, rep_mpi_1, rep_mpi_2, SIMPLIFY=FALSE)
